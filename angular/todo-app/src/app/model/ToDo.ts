...
class ToDo {
    ...
    add(item) {
        ...
        // Open Request
        xhttp.open("POST", "http://localhost/angular/api/save.php", true);
    ...
    saveToLocalStorage() {
        ...
        // Open Request
        xhttp.open("POST", "http://localhost/angular/api/saveAll.php", false);
        // Set Header to be POST type
        xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
        // Send Request with stringified Object
    ...
    loadFromLocalStorage() {
        ...
        xhttp.open("POST", "http://localhost/angular/api/load.php", false);
        // Set Header to be POST type
        xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
        // Add Callback function to the Request
        xhttp.onreadystatechange = function() {
